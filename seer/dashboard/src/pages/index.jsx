          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6">
              ...
              <div className="bg-white p-4 md:p-6 rounded-lg shadow-lg">
                ...
                <p className="text-2xl md:text-3xl font-bold text-orange-500">0</p>
              </div>
              <div className="bg-white p-4 md:p-6 rounded-lg shadow-lg">
                <h3 className="text-gray-500 text-sm font-medium">Active Crawl Jobs</h3>
                <p className="text-2xl md:text-3xl font-bold text-gray-800">N/A</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 mb-6">
              ...
              <div className="bg-white p-4 md:p-6 rounded-lg shadow-lg">
                ...
                <p className="text-xs text-gray-400 mt-4 text-right">{new Date().toLocaleString()} (Live)</p>
              </div>
            </div>
